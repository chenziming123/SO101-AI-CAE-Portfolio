...
- V3 visual smoke URDF：`<repo>/05_improved_design/upper_arm_v3/urdf_smoke/so101_upper_arm_v3_visual_smoke.urdf`

## Mesh 缩放检查

- V3 原始 STL 包围盒：[150.5, 36.0, 39.299999]
- 缩放后仿真 mesh 包围盒：[0.1505, 0.036, 0.0393] m
